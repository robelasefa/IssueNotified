    ...
    if response.status_code == 200:
        if response is None:
            ...
            for issue in issues:
                ...
                try:
                    if checked_issue(issue_info["id"]):
                        issue_url_button = InlineKeyboardButton(text='View Issue', url=issue_info["url"])  # Define an InlineKeyboardButton object for the button
